...
<section id="breadcrumbs" class="breadcrumbs">
    <div class="container">
        <?= get_breadcumb('Pengaduan','Pengaduan Masuk') ?>
    </div>
</section>
<!-- ======= Hero Section ======= -->
<div class="container">
    ...
    <div class="row">
        <div class="col">
            <a href="#" class="btn btn-primary"> + Buat Aduan Baru</a>
        </div>
    </div>
    <?php } ?>
                ...
                <tbody>
                    ...
                    for ($i = 0; $i < 10; $i++) { ?>
                        <tr>
                            ...
                            <td style="text-align: center;"><span class="badge bg-primary">Menunggu Ditanggapi</span></td>
