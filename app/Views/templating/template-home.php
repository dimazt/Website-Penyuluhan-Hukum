...
<body>
    ...
    <header id="header" class="d-flex align-items-center">
        <div class="container d-flex justify-content-between align-items-center">
            ...
            <div class="logo">
                <h1><a href="#">Penyuluhan Hukum</a></h1>
                ...
                <ul>
                    ...
                    <?php if (session('isLogin') == false) { ?>
                        ...
                        if (session('role') == 'admin') { ?>
                            <li><a href="<?= base_url() ?>/admin/pasal/view-pasal">Data Pasal</a></li> <?php } ?>
                        <li class="dropdown"><a href="#"><span>Pengaduan</span> <i class="bi bi-chevron-down"></i></a>
                            <ul>
                                <li><a href="<?= base_url() ?>/users/pengaduan/<?= 'menunggu-ditanggapi' ?>">Pengaduan Dalam Antrian</a></li>
                                <li><a href="<?= base_url() ?>/users/pengaduan/<?= 'ditanggapi' ?>">Pengaduan Ditanggapi</a></li>
                            </ul>
                        </li>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#summernote').summernote({
                placeholder: 'Jelaskan aduan anda ... </br> Kolom dapat diperkecil dan perbesar',
                tabsize: 2,
                height: 200,
                toolbar: [
